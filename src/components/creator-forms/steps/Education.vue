    ...
    <div class="container step">
      <div class="mt-0">
       ...
       <div  v-for="(school, key, index) in schools" :key="key" :class="['container-fluid list-item p-0 school mb-2',{'mt-0' : index > 0},{open:statuses['status'+index]}]">
          <header @click="changeCurrent(index)" class="row p-4">
              <simple-svg class="d-inline-block mx-3" :stroke="'none'" :fill="'#4b92e2'" :filepath="require('@/assets/step_icons/university.svg')"  :width="'25px'" :height="'25px'"/>
              ...
              <simple-svg :class="['ml-auto mr-3 my-auto', {rotated: statuses['status'+index]}]" :stroke="'none'" :fill="'#4b92e2'" :filepath="require('@/assets/images/arrow.svg')"  :width="'15px'" :height="'15px'"/>  
          </header>
          <transition name="open-window">
            <div v-if="statuses['status'+index]" class="newSchool_form p-4 container-fluid">
                <div class="row mb-5 align-middle">
                    ...
                    <h6>{{sentence ? sentence : 'Здесь будет отображаться информация, сформированная на основе введенных данных. Если составленное предложение будет корректно отметьте чекбокс справа'}}</h6>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row align-middle mb-4">
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 pl-0 pr-xl-3 pr-lg-3 pr-md-3 pr-sm-0 pr-0">
                            <input id="school_name" type="text" placeholder="Название учебного заведения" :class="['block_neutral col-12 pl-4 py-3 mb-xl-0 mb-lg-0 mb-md-4 mb-sm-4 mb-4']" 
                    ...
                    <div class="row">
                        <input id="major" type="text" maxlength="135" placeholder="Введите специальность..." :class="['block_neutral pl-4 py-3 col-12 mr-3 mb-4']" 
                    ...
                    <div  class="container-fluid px-0">
                        <div class="row px-0">
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 pl-0 pr-xl-3 pr-lg-3 pr-md-3 pr-sm-2 pr-2 mb-xl-0 mb-lg-0 mb-md-0 mb-sm-4 mb-4">
                                <input id="begin_year" :class="['block_neutral col-12 pl-4 py-3']" type="text" placeholder="Год начала"
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 text-right mr-0 pl-xl-0 pl-lg-0 pl-md-0 pl-sm-2 pl=2 pr-xl-3 pr-lg-3 pr-md-3 pr-sm-0 pr-0 mb-xl-0 mb-lg-0 mb-md-0 mb-sm-4 mb-4">    
                                <input id="end_year" :class="['block_neutral col-12 pl-4 py-3']"  type="text" :placeholder="school.endYear.not_required ? '----' : 'Год окончания'" :disabled="school.endYear.not_required"
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 text-right mr-0 px-0">    
                                <input id="degree" :class="['block_neutral col-12 pl-4 py-3']"  type="text" placeholder="Степень" 
